    ...
    "paths": {
        ...
        "/assessments/pre-assessment": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Slug bộ đề cụ thể (vd: pre_assessment_default)",
                        "name": "code",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "Bộ câu hỏi pre-assessment",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.AssessmentSet"
                                        }
                                    }
                                }
                            ]
                    ...
                    "404": {
                        "description": "Chưa có bộ đề active",
                        "schema": {
                            "$ref": "#/definitions/domain.Response"
                        }
                    }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.DailyChallenge"
                                        }
                                    }
                                }
                            ]
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/service.DailyHistoryItem"
                                            }
                                        }
                                    }
                                }
                        ...
                        "schema": {
                            "allOf": [
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.DailyMission"
                                        }
                                    }
                                }
                            ]
        ...
        "/daily/mission/heartbeat": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Active seconds delta",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/daily/today": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "Today's challenge summary (available=false nếu chưa có challenge)",
                        "schema": {
                            "allOf": [
                                {
                                    "$ref": "#/definitions/domain.Response"
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "$ref": "#/definitions/service.DailyChallengeSummary"
                                        }
                                    }
                                }
                            ]
    ...
    "definitions": {
        ...
        "service.AssessmentSet": {
            ...
            "properties": {
                ...
                "questions": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.AssessmentQuestion"
                    }
                },
                "title": {
                    "type": "string"
        ...
        "service.DailyChallenge": {
            ...
            "properties": {
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.DailyChallengeItem"
                    }
                },
                "message": {
                    "type": "string"
                ...
                "user_status": {
                    "description": "completed | in_progress | missed | null",
                    "type": "string"
                }
            }
        },
        "service.DailyChallengeItem": {
            "type": "object",
            "properties": {
                "content_item": {
                    "$ref": "#/definitions/service.ContentItem"
                ...
                "kind": {
                    "description": "word | sentence | passage",
                    "type": "string"
                },
                "order": {
                    "type": "integer"
                ...
                "passage": {
                    "$ref": "#/definitions/service.DailyPassage"
                }
            }
        },
        "service.DailyChallengeSummary": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "boolean"
        ...
        "service.DailyMission": {
            ...
            "properties": {
                ...
                "minutes_done": {
                    "description": "capped at goal for \"X/X\" display",
                    "type": "integer"
                },
                "percent": {
                ...
                "seconds_done": {
                    "description": "raw, may exceed goal",
                    "type": "integer"
                },
                "status": {
                ...
                "xp_earned": {
                    "description": "XP earned today from the mission",
                    "type": "integer"
                }
            }
        },
        "service.DailyPassage": {
            "type": "object",
            "properties": {
                "difficulty": {
                    "type": "integer"
        ...
        "service.Home": {
            ...
            "properties": {
                ...
                "header": {
                    "$ref": "#/definitions/service.HomeHeader"
                },
                "practice_modes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/service.PracticeModeCard"
                    }
                }
            }
        },
